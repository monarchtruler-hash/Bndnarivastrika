...
app = FastAPI(title="Vastrika API", version="1.0.0")
...
def send_order_confirmation_email(order_details, customer_email, customer_name):
    ...
    try:
        ...
        subject = f"✨ Order Confirmed! - {order_details['id']} - Vastrika"
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <p>Thank you for shopping with Vastrika! Your order has been successfully placed and is being processed with care.</p>
        ...
        html_content += f"""
                ...
                <div class="footer">
                    <p>© 2024 Vastrika. All rights reserved.</p>
...
def send_order_status_update_email(order_details, customer_email, customer_name, old_status, new_status):
    ...
    try:
        ...
        subject = f"{emojis.get(new_status, '📦')} Order Status Update - {order_details['id']} - Vastrika"
        ...
        <body>
            <div class="container">
                <div class="header"><h1>✨ VASTRIKA ✨</h1><p>Order Status Update</p></div>
                <div class="content">
...
@app.get("/products/images/{image_id}")
...
@app.get("/products/with-discounts/")
...
@app.post("/admin/verify-payment/{order_id}")
def verify_payment(
    order_id: str,
...
def root():
    return {
        "message": "Welcome to Vastrika API", 
        "status": "running",
